<?php 
	...
	$image = 'https://sitetoimage.com/api/screenshot?token=token-768ce37760ce31a4dfd49014705d6970ffb80b9a1391d918c273932eb6650aa6&fileType=jpeg&width=1200&url=https://icoop.live/ic/farmer_doc_agrivar.php?id='.$id_plantation;
	...
	$fp = 'img/capture/'.$id_plantation.'_agv.jpg'; 
	...
	if (file_exists($fp)) {
		...
		if($arr_result){
			...
			VALUES ($new_id, $id_plantation, '$doc_link', 649, '$doc_date', 'Agrivar')";
