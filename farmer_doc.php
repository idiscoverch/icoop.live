<?php
	...
	// Contact
	$sqlC="SELECT lastname, firstname, name_town FROM v_icw_contacts WHERE id_contact = $id_contact";
	...
	<div style="width:80%; margin:45px auto;" id="capture">
		<div class="row">
			<div class="col-print-3">
				<img src="img/PMCI-logo_200px.jpg" class="img-responsive" />
			</div>
			<div class="col-print-9">
				<h3 class="bordure_dwn">Plantations Modernes de Côte d’Ivoire</h3>
			</div>
		</div>
